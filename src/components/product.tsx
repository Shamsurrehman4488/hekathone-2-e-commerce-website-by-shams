...
const FeaturedProducts = () => {
  ...
  return (
    <div className=" w-full md:w-[1200px] md:ml-20 px-4 md:px-28 py-6 mx-auto my-4">
      <h2 className="text-2xl  font-bold text-center md:text-left mb-8">Featured Products</h2>
