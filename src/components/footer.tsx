          ...
          <div className="col-span-2 sm:col-span-2 md:col-span-1 space-y-4">
            <div className="flex items-center gap-2 mb-6">
              <Image
                ...
                className="h-auto"
              />
              <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider">Comforty</h3>
            </div>
      ...
      <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2 text-xs">
              <li><Link href="#" className="text-[#272343] hover:text-[#007580] hover:underline">Sofa</Link></li>
              <li><Link href="#" className="text-[#272343] hover:text-[#007580] hover:underline">Armchair</Link></li>
              <li><Link href="#" className="text-[#272343] hover:text-[#007580] hover:underline">Wing Chair</Link></li>
              <li><Link href="#" className="text-[#272343] hover:text-[#007580] hover:underline">Desk Chair</Link></li>
              <li><Link href="#" className="text-[#272343] hover:text-[#007580] hover:underline">Wooden Chair</Link></li>
              <li><Link href="#" className="text-[#272343] hover:text-[#007580] hover:underline">Park Bench</Link></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2 text-xs">
              <li><Link href="#" className="text-[#272343] hover:text-[#007580] hover:underline">Help & Support</Link></li>
              ...
              <li><Link href="#" className="text-[#272343] hover:text-[#007580] hover:underline">Help</Link></li>
            </ul>
          </div>

          {/* Newsletter Section */}
          <div className="col-span-2 sm:col-span-2 md:col-span-1">
            <h3 className="text-sm font-semibold text-[#9A9CAA] uppercase tracking-wider mb-4">NEWSLETTER</h3>
        ...
        <div className="mt-8  pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-xs text-center md:text-left">
              © 2023 - Design & Developed by <b className="text-gray-500">Peterdraw</b>
            </p>
            <div className="flex items-center justify-center flex-wrap gap-4">
              {[1, 2, 3, 4].map((num) => (
                <Image
                  key={num}
                  src={`/images/bank${num}.png`}
